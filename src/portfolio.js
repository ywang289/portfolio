...
const greeting = {
  username: "Yifan(Eva) Wang",
  title: "Hi all, I'm Eva",
  subTitle: emoji(
    "A passionate Full Stack Software Developer, particularly focused on financial applications, with experience in building web and mobile applications using TypeScript, React.js, Golang, React Native, and other modern libraries and frameworks."
  ),
  resumeLink:
    "https://drive.google.com/file/d/13zpnlVRhKBAmtIuVoFU0kzynVVGNQdLO/view?usp=sharing", // Set to empty to hide the button
  ...
  schools: [
    {
      ...
      duration: "September 2022 - Decemenber 2023",
      descBullets: ["Teaching Assistant for COMS 6156 in Spring 2022"]
    },
    {
  ...
  experience: [
    {
      ...
      company: "Torpago",
      companylogo: require("./assets/images/TorpagoLogo.png"),
      date: "Sep 2024 – Present",
      desc: "Implemented the frontend for the Torpago Payment System using SolidJS and used Golang and Kubernetes for cloud platform control."
    },
    {
...
const contactInfo = {
  ...
  email_address: "yifan00925@gmail.com"
};
